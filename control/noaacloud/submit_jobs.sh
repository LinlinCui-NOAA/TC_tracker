...
#run directories
export PACKAGEROOT=${5:-/contrib/Linlin.Cui/git/LinlinCui-NOAA/TC_tracker}
export DATAROOT=${6:-/lustre2/Linlin.Cui/MLGEFSv1.0/ptmp}
export COMINSYN=${7:-/lustre2/Linlin.Cui/MLGEFSv1.0/}
