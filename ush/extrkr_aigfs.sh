...
#    PARMlist="(UGRD:850|UGRD:700|UGRD:500|VGRD:850|VGRD:700|VGRD:500|UGRD:10 m a|VGRD:10 m a|ABSV:850|ABSV:700|MSLET|HGT:900|HGT:850|HGT:800|HGT:750|HGT:700|HGT:650|HGT:600|HGT:550|HGT:500|HGT:450|HGT:400|HGT:350|HGT:300|TMP:500|TMP:450|TMP:400|TMP:350|TMP:300)" 
    PARMlist="(UGRD:850|UGRD:700|UGRD:500|VGRD:850|VGRD:700|VGRD:500|UGRD:10 m a|VGRD:10 m a|PRMSL|HGT:925|HGT:850|HGT:700|HGT:600|HGT:500|HGT:400|HGT:300|TMP:500|TMP:400|TMP:300)"
...
#     300 to 900 mb, every 50 mb....
      ...
      echo "        g2_model=${model}/"       >>${namelist}
      export FORT11=${gfile}
      export FORT16=${FIXens_tracker}/aigfs_hgt_levs.txt
      export FORT31=${ifile}
...
#     300 to 500 mb, every 50 mb....
      ...
      echo "        g2_model=${model}/"       >>${namelist}
      export FORT11=${gfile}
      export FORT16=${FIXens_tracker}/aigfs_tmp_levs.txt
      export FORT31=${ifile}
